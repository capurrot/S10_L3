...
const FilmComponent = ({ filmSearch }) => {
    ...
    <>
      ...
      {films.length === 0 && !isLoading && (
        <Alert variant="danger" className="mb-5">
          Nessun Film con ricerca {'"' + filmSearch + '"'} trovato
        </Alert>
      )}
      ...
      {showDetails && <ModalComponent show={showDetails} handleCloseDetails={handleCloseDetails} film={selectedFilm} />}
    </>
  );
};
